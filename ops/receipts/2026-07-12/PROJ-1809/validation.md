...
- Focused demo regression: 13 tests passed.
...
- Root `npm run verify`: passed; 142 backend test files and 1,524 tests passed before the CLI, SDK, legacy web, and `web-next` build gates completed.
