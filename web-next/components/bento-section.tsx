  ...
  return (
    <div className="w-full rounded-2xl border border-border bg-card overflow-hidden">
      ...
      <div className="px-5 sm:px-6 py-3.5 border-t border-border/40 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-foreground/45 text-xs font-mono">one governed ranking, multiple signal types</p>
    ...
    <div className="w-full rounded-2xl border border-border bg-card overflow-hidden">
      ...
      <div className="grid gap-0 border-t border-border/50 md:grid-cols-2">
        <div className="border-b border-border/50 px-5 py-4 md:border-b-0 md:border-r sm:px-6">
          <p className="text-xs font-mono uppercase tracking-[0.18em] text-foreground/45">Before epoch</p>
          <div className="mt-3 space-y-2 text-sm text-foreground/65">
            <p><span className="font-mono text-foreground/45">#1</span> high-engagement general post</p>
            <p><span className="font-mono text-foreground/45">#2</span> useful source-rich explainer</p>
          </div>
        </div>
        <div className="px-5 py-4 sm:px-6">
          <p className="text-xs font-mono uppercase tracking-[0.18em] text-foreground/45">After weights update</p>
          <div className="mt-3 space-y-2 text-sm text-foreground/65">
            <p><span className="font-mono text-primary/70">#1</span> useful source-rich explainer</p>
            <p><span className="font-mono text-foreground/45">#2</span> high-engagement general post</p>
          </div>
        </div>
      </div>
    </div>
...
const features = [
  {
    ...
    description:
      "A governed recommender has to reconcile recency, engagement, bridging, source diversity, and relevance in one ranking. These are illustrative scenarios; the demo is where bounded live receipts can be inspected.",
