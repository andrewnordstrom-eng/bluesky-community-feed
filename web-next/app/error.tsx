    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 flex items-center justify-center px-5 py-20 md:py-28">
        <div className="w-full max-w-md flex flex-col items-center gap-4 text-center">
          <p className="text-[11px] font-mono uppercase tracking-[0.22em] text-foreground/55">Something went wrong</p>
          ...
          <p className="max-w-sm text-base leading-relaxed text-foreground/60">
            An unexpected error occurred while loading this page. You can try again, or head back to safe ground.
          </p>
