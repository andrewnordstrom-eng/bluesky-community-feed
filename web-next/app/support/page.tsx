...
const SECTIONS = [
  ...
  },
  {
    ...
    body: (
      <>
        <P>Open a GitHub issue and, where you can, include:</P>
        <UL>
        ...
        <P>Please don&rsquo;t include your app password or any credential in a public issue.</P>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <P>
          ...
          product — or to how governance itself works — on <InlineLink href={GITHUB_ISSUES}>GitHub</InlineLink>. For
